...
_C.INPUT.FLIP_PROB_TRAIN = 0.0  #fixme 0-->0.5
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = 16  # the number of classes including background
_C.MODEL.FCOS.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.MODEL.FCOS.PRIOR_PROB = 0.01
_C.MODEL.FCOS.INFERENCE_TH = 0.05
_C.MODEL.FCOS.NMS_TH = 0.5              #fixme 0.6-->0.5
_C.MODEL.FCOS.PRE_NMS_TOP_N = 2000      #fixme 1000-->2000
...
_C.TEST.DETECTIONS_PER_IMG = 2000  #debug 在inference中预测修改 100-->2000--->3000
